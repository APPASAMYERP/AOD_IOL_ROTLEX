<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LatheCut_Report.aspx.cs" Inherits="LatheCut_Report" Title="LatheCut_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table width="100%" id="table_left">
            ...
            <td>
                ...
                <cc1:CalendarExtender ID="txtDate_CalendarExtender" runat="server" 
                    Enabled="True" Format="dd/MM/yyyy" TargetControlID="txtDate">
                        ...
                        <td>
                <asp:DropDownList ID="ddlShift" runat="server" CssClass="textbox" Height="22px" 
                                Width="128px">
        ...
        <cc1:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
                ...
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" Height="429px">
                </rsweb:ReportViewer>
                        </td>
                    </tr>
                </table>
