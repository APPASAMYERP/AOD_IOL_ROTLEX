<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RotlexUpload.aspx.cs" Inherits="RotlexUpload" %>
...
<asp:Content ID="content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <tr id="Buttons" runat="server">
     <td>
        ...
        <tr>
            <td align="right"><asp:Button ID="btnaps" runat="server" Text="APS" 
                    onclick="btnaps_Click" /></td>        
            <td><asp:Button ID="btnmoria" runat="server" Text="Moria" 
   ...
   <td>   
    ...
    <td><asp:Button ID="btnclo" runat="server" Text="Close" onclick="btnclo_Click" /></td>
      ...
      <td align="center">     
          <asp:Button ID="Button2" runat="server" Text="DataUpload" OnClick="Linkbutton1_Click" />       
      </td>
          <td align="center">
