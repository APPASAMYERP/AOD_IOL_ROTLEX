<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Resolution.aspx.cs" Inherits="Resolution" Title="Resolution" %>
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td style="background-color: #00207D; font-family: Arial; font-size: 10pt; font-weight: bold; color: #FFFFFF; padding: 7px; text-align:left;">
                                <asp:Label ID="Label2" runat="server" Text="Resolution"></asp:Label></td>
                        </tr>
                        <tr>
                            <td align="left">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtFinishedQuantity" runat="server" AutoPostBack="True" 
                    ...
                    CssClass="textbox" MaxLength="2" TabIndex="2"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtAcceptedQuantity" runat="server" AutoPostBack="True" 
                    ...
                    CssClass="textbox" MaxLength="2" TabIndex="3"></asp:TextBox>
...
<%--            <td class="textlbl">
            ...
            <td>
                <asp:TextBox ID="txtRemarks" runat="server" CssClass="textbox" 
                    AutoPostBack="True" ontextchanged="txtRemarks_TextChanged" TabIndex="4"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtBlockedBy" runat="server" CssClass="textbox" 
                    AutoPostBack="True" ontextchanged="txtBlockedBy_TextChanged" TabIndex="5"></asp:TextBox>
            ...
            <td class="textlbl">
                Shift</td>
            <td>
                <asp:DropDownList ID="drpShift" runat="server" CssClass="dropdown" TabIndex="6">
        ...
        <tr>
            ...
            <td class="textlbl">
                Date</td>
            <td>
                <asp:TextBox ID="txtDate" runat="server" CssClass="textbox" TabIndex="7" AutoPostBack="True" 
                   ></asp:TextBox>
